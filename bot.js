...
if (minutes < 10) {//Toxic Codes
minutes = "0" + minutes;
}
var suffix = "AM";
if (hours >= 12) {//Toxic Codes
suffix = "PM";
hours = hours - 12;
}
if (hours == 0) {//Toxic Codes
hours = 12;
}
  ...
  if(message.content.startsWith(prefix + "giveaway")) {
    ...
    message.channel.send(`:eight_pointed_black_star:| **Send Name channel For the Giveaway**`).then(msg => {
      message.channel.awaitMessages(filter, {
        max: 1,//Toxic Codes
        time: 20000,//Toxic Codes
        errors: ['time']//Toxic Codes
              ...
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  message.guild.channels.find("name" , room).send(' :heavy_check_mark: **Giveaway Created** :heavy_check_mark:' , {embed: giveEmbed}).then(m => {
                    ...
                    message.guild.channels.find("name" , room).send(`**Congratulations ${gFilter}! You won The \`${title}\`**` , {embed: {}})//Toxic Codes
                }, ms(duration));//Toxic Codes
            });//Toxic Codes
                } catch(e) {//Toxic Codes
                message.channel.send(`:heavy_multiplication_x:| **i Don't Have Prem**`);//Toxic Codes
                  console.log(e);//Toxic Codes
                }//Toxic Codes
              });//Toxic Codes
            });//Toxic Codes
          });//Toxic Codes
